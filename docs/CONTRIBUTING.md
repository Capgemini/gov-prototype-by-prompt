...
### GitHub Code Quality and Code Scanning

We use [GitHub Code Quality](https://docs.github.com/en/code-security/code-quality) to automatically check for issues that may impact reliability or maintainability, and [GitHub Code Scanning](https://docs.github.com/en/code-security/code-scanning) to automatically scan for potential security vulnerabilities and other errors. All issues identified in a pull request must be resolved (either fixed or dismissed) before it can be merged.
